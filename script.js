...
addbtn.addEventListener('click', function() {
  ...
  if(
    ...
    warn.innerHTML = 'enter field correctly';
  } else {
    nameInp.value = '';
    scoreInp.value = '';
    nameInp.focus();
    ...
    _aveField.innerHTML = `averge is ${aver}`;
    if(score > maxi.score) {
      maxi.score = score;
      maxi.name = name;
      _maxField.innerHTML = maxi.name + ' max with score of ' + maxi.score;
    ...
    if(score < mini.score) {
      mini.score = score;
      mini.name = name;
      _minField.innerHTML = mini.name + ' min with score of ' + mini.score;
    }
...
_show.addEventListener('click', function() {
  ...
  if( !(temp) || 
    ...
    console.log('warn');
    _spanFilter.innerHTML = 'enter grade correct';
  } else {
